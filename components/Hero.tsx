      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        <div className="flex justify-center space-x-8 mt-16 animate-slide-in-left">
          <a
            ...
            className="group p-4 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all duration-300 transform hover:scale-125 hover:rotate-12"
          >
            <svg
              className="w-8 h-8 text-white group-hover:text-blue-400 transition-colors"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
